  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <StatCard label="Previous Week" value={prevWeek.total} tooltip="Last week's total on-demand streams. The percentage and sparkline show the week-over-week trend across the last 6 weeks." pctChange={((latestWeek.total - prevWeek.total) / prevWeek.total) * 100} sparkData={tylaWeeklyData.slice(-6).map(w => w.total)} />
      </div>
